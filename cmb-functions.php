 ...
 *
 * Be sure to replace all instances of 'decconek_' with your project's prefix.
 ...
 */
function decconek_show_if_front_page( $cmb ) {
 ...
 * @return bool                     True if metabox should show
 */
function decconek_hide_if_no_cats( $field ) {
 ...
 */
function decconek_render_row_cb( $field_args, $field ) {
 ...
 * @param  CMB2_Field $field      The field object
 */
function decconek_display_text_small_column( $field_args, $field ) {
	?>
 ...
 * @param  CMB2_Field object $field      Field object
 */
function decconek_before_row_if_2( $field_args, $field ) {
...
add_action( 'cmb2_admin_init', 'decconek_register_demo_metabox' );
/**
 * Hook in and add a demo metabox. Can only happen on the 'cmb2_admin_init' or 'cmb2_init' hook.
 */
function decconek_register_demo_metabox() {
	$prefix = 'decconek_demo_';
	...
	$cmb_demo = new_cmb2_box( array(
		...
		// 'show_on_cb' => 'decconek_show_if_front_page', // function should return a bool value
		// 'context'    => 'normal',
		// 'priority'   => 'high',
		...
		// 'classes_cb' => 'decconek_add_some_classes', // Add classes through a callback.
	) );
	...
	$cmb_demo->add_field( array(
		...
		'id'         => $prefix . 'text',
		'type'       => 'text',
		'show_on_cb' => 'decconek_hide_if_no_cats', // function should return a bool value
	...
	$cmb_demo->add_field( array(
		...
		// );
		// 'display_cb' => 'decconek_display_text_small_column', // Output the display of the column values through a callback.
	) );
	...
	$cmb_demo->add_field( array(
		...
		'type' => 'text',
		'render_row_cb' => 'decconek_render_row_cb',
	) );
	...
	$cmb_demo->add_field( array(
		...
		'type'         => 'text',
		'before_row'   => 'decconek_before_row_if_2', // callback
...
add_action( 'cmb2_admin_init', 'decconek_register_about_page_metabox' );
/**
 * Hook in and add a metabox that only appears on the 'About' page
 */
function decconek_register_about_page_metabox() {
	$prefix = 'decconek_about_';
...
add_action( 'cmb2_admin_init', 'decconek_register_repeatable_group_field_metabox' );
/**
 * Hook in and add a metabox to demonstrate repeatable grouped fields
 */
function decconek_register_repeatable_group_field_metabox() {
	$prefix = 'decconek_group_';
...
add_action( 'cmb2_admin_init', 'decconek_register_user_profile_metabox' );
/**
 * Hook in and add a metabox to add fields to the user profile pages
 */
function decconek_register_user_profile_metabox() {
	$prefix = 'decconek_user_';
...
add_action( 'cmb2_admin_init', 'decconek_register_taxonomy_metabox' );
/**
 * Hook in and add a metabox to add fields to taxonomy terms
 */
function decconek_register_taxonomy_metabox() {
	$prefix = 'decconek_term_';
...
add_action( 'cmb2_admin_init', 'decconek_register_theme_options_metabox' );
/**
 * Hook in and register a metabox to handle a theme options page
 */
function decconek_register_theme_options_metabox() {

	$option_key = 'decconek_theme_options';
